...
public class SwipeMenuListView extends ListView {
	...
	private List<Integer> disEnableLists = null;
	...
	public void setDisEnableList(List<Integer> disEnableLists) {
		this.disEnableLists = disEnableLists;
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (disEnableLists != null) {
				if (disEnableLists.contains(mTouchPosition)) {
