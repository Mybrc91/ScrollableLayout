...
/**
 * A simple extension of a regular linear layout that supports the divider API of Android 4.0+. The
 * dividers are added adjacent to the children by changing their layout params. If you need to rely
 * on the margins which fall in the same orientation as the layout you should wrap the child in a
...
public class IcsLinearLayout extends NineLinearLayout {
    ...
    public IcsLinearLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray
                a =
                context.obtainStyledAttributes(attrs, /*com.android.internal.R.styleable.*/
                        R_styleable_LinearLayout);

        setDividerDrawable(a.getDrawable(/*com.android.internal.R.styleable.*/LinearLayout_divider));
        mShowDividers =
                a.getInt(/*com.android.internal.R.styleable.*/LinearLayout_showDividers, SHOW_DIVIDER_NONE);
        mDividerPadding =
                a.getDimensionPixelSize(/*com.android.internal.R.styleable.*/LinearLayout_dividerPadding,
                        0);
     ...
     *
     * @param showDividers One or more of {@link #SHOW_DIVIDER_BEGINNING}, {@link
     *                     #SHOW_DIVIDER_MIDDLE}, or {@link #SHOW_DIVIDER_END}, or {@link
